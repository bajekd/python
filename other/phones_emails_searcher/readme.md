Idea based on book Automate the Boring Stuff with Python and https://www.youtube.com/watch?v=K8L6KVGG-7o&list=WL&index=2&t=0s

### What does this script do:
Filter text from your clipboard to find mobile phone numbers and email addresses, if find some paste them
to your clipboard.
